...
exports.default = {
  ...
  Query: {
    allClients: _permissions.isAuth.createResolver(async (parent, { cursor, searchText }, { models }) => {
      const options = {
    ...
    autocompleteClients: _permissions.isAuth.createResolver(async (parent, { searchText }, { models }) => {
      const options = {
        order: [['createdAt', 'DESC']],
        where: {},
        limit: 10
    ...
    getClient: _permissions.isAuth.createResolver(async (parent, args, { models }) => {
  ...
  Mutation: {
    createClient: _permissions.isAuth.createResolver(async (parent, args, { models, user }) => {
      try {
        const resp = await models.sequelize.transaction(async transaction => {
    ...
    updateClient: _permissions.isAuth.createResolver(async (parent, args, { models, user }) => {
      try {
        const resp = await models.sequelize.transaction(async transaction => {
    ...
    deleteClient: _permissions.isAuth.createResolver(async (parent, args, { models }) => {
